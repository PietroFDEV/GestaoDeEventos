...
function CreateEvent(){
    const [event, setEvent] = useState({ titulo: '', descricao: '', categoria_id: 0, capacidade: 0, data: '', hora: '', endereco: '', local: '', Preco: 0.0 })
    ...
    return (
        <div className="ce-page">
            ...
            <div className="ce-container">
                ...
                <div className="ce-field-div">
                    <p className="ce-field-title">Valor do ingresso</p>
                    <input type="number" placeholder="0.00" className="ce-field" onChange={(e) => setEvent({ ...event, Preco: e.target.value })} />
                </div>
